...
# Method: playACard
# Description: A hand of cards is input and an individual playing card. If the individual playing
# card is found in the hand it is removed from the hand.
...
# True if no card is found this function returns False.
...
#def play():
#    noOfHands = int(input('Please enter the number of players. '))
#    generateDeck()
#    dealCards(deck,noOfCards,noOfHands,hands=[])